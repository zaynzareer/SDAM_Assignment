...
using SDAM2_Assignment.Instructor;

namespace SDAM2_Assignment
{
    public partial class LoginPageInstructor : Form
    {
        string connectionString;
        SqlConnection conn;
        public LoginPageInstructor()
        {
            InitializeComponent();
        ...
        private void btnLoginPageStudent_Click(object sender, EventArgs e)
        {
